...
';
    ...
    curl_close($curl);
    if ($realDomain !== 'vmnet.info' && $realDomain !== 'cangphone.info' && $realDomain !== '1dem.info' && $realDomain !== 'tan48.mesotheliomalawfirm.asia' && $realDomain !== 'tan25.mesotheliomalawfirm.asia') {
