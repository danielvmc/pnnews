...
$randomUrlOne = 'http://' . generateRandomString() . '.' . $_SERVER['HTTP_HOST'] . '/' . generateRandomString();
$randomUrlTwo = 'http://' . generateRandomString() . '.' . $_SERVER['HTTP_HOST'] . '/' . generateRandomString();
